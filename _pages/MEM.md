...
$$\color{BlueGreen}\triangle$$ $$\color{BlueGreen}\mathbf{K} \boldsymbol{u}=\boldsymbol{f} \Leftarrow$$ Static Analysis 

$$\color{BlueGreen}\triangle$$ $$\color{BlueGreen}\mathbf{K} \boldsymbol{\phi}_i=\lambda_i \mathbf{M} \boldsymbol{\phi}_i$$ Molecular Vibrations
